...
SPELL_GROUPS = {
    "magic_training": (
        ...
        dict(ability_id="mana_scar", name="魔力伤痕", effects=(status("resistance_magic_down", 30, magnitude=0.25),), ai_tags=("debuff",)),
    ...
    "barrier": (
        ...
        dict(ability_id="mana_barrier", name="魔力结界", effects=(status("mana_barrier", 40, magnitude=0.30, target="self", beneficial=True, params={"resistance_magic": 0.30}),), targeting="self", cast_range=0, ai_tags=("defense",)),
    ...
    "elemental_guidance": (
        ...
        dict(ability_id="elemental_protection", name="元素保护", effects=(status("elemental_protection", 40, magnitude=0.30, target="self", beneficial=True, params={"resistance_fire": 0.30, "resistance_cold": 0.30, "resistance_lightning": 0.30}),), targeting="self", cast_range=0, ai_tags=("defense",)),
        dict(ability_id="elemental_scar", name="元素伤痕", effects=(status("elemental_scar", 35, magnitude=0.25, params={"resistance_fire": -0.25, "resistance_cold": -0.25, "resistance_lightning": -0.25}),), ai_tags=("debuff",)),
    ...
    "shadow_magic": (
        ...
        dict(ability_id="shadow_cloak", name="暗影斗篷", effects=(status("shadow_cloak", 40, magnitude=0.30, target="self", beneficial=True, params={"resistance_cold": 0.30, "resistance_shadow": 0.30, "paralysis_immunity": True}),), targeting="self", cast_range=0, ai_tags=("defense",)),
    ),
    "blessing": (
    ...
    "necromancy": (
        ...
        dict(ability_id="death_shadow", name="死亡阴影", effects=(status("resistance_hell_down", 35, magnitude=0.25),), ai_tags=("debuff",)),
        ...
        dict(ability_id="dim_light", name="昏暗之光", effects=(status("dim_light", 40, magnitude=0.35, target="self", beneficial=True, params={"resistance_hell": 0.35}),), targeting="self", cast_range=0, ai_tags=("defense",)),
    ),
    "mind_control": (
        ...
        dict(ability_id="nightmare", name="噩梦", effects=(status("nightmare", 35, magnitude=0.25, params={"resistance_shadow": -0.25, "resistance_hell": -0.25, "resistance_mind": -0.25}),), ai_tags=("debuff",)),
        ...
        dict(ability_id="mental_guard", name="精神监护", effects=(status("mental_guard", 40, magnitude=0.35, target="self", beneficial=True, params={"resistance_mind": 0.35}),), targeting="self", cast_range=0, ai_tags=("defense",)),
    ...
    "natural_knowledge": (
        ...
        dict(ability_id="tree_skin", name="树肤术", effects=(status("tree_skin", 40, magnitude=0.25, target="self", beneficial=True, params={"defense": 0.25, "resistance_cold": 0.25, "bleed_resistance": 0.50}),), targeting="self", cast_range=0, ai_tags=("defense",)),
        ...
        dict(ability_id="poison_resistance", name="毒液抵抗", effects=(status("poison_resistance", 40, magnitude=0.35, target="self", beneficial=True, params={"resistance_nature": 0.35}),), targeting="self", cast_range=0, ai_tags=("defense",)),
