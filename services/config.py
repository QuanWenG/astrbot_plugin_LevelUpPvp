...
BATTLE_WIN_EXP_RANDOM_MULTIPLIER_RANGE = (0.75, 1.25)
BATTLE_LOSE_EXP_RANDOM_MULTIPLIER_RANGE = (0.75, 1.25)
BATTLE_WIN_EXP_LEVEL_DIFF_STEP = 0.08
BATTLE_LOSE_EXP_LEVEL_DIFF_STEP = 0.1
BATTLE_WIN_EXP_LEVEL_MULTIPLIER_RANGE = (0.45, 1.8)
BATTLE_LOSE_EXP_LEVEL_MULTIPLIER_RANGE = (0.45, 2.0)
LLM_RATE_WEIGHT = 0.3
